   ...
   totalValue += this.state.shippingPrice
    ...
    return (
      ...
      <Toast style={{backgroundColor: 'grey'}} textStyle={{color: '#fff'}} ref="toast" position='top'/>
        ...
        <ScrollView   style={{flex:1,paddingLeft:10, paddingRight:10, paddingBottom:30,}} >


          <View style={{ flexWrap: 'nowrap',backgroundColor:'#fff',height:height*0.6 }}>
          ...
          <FlatList
                  ...
                  <View style={{ flex: 1, alignItems: 'flex-start', paddingTop: 10,backgroundColor:'#fff' }}>
                    ...
                    <TouchableOpacity onPress={()=>this.removeItem(item,index)} style={{height:20,width:20,position:'absolute',left:2,top:0,paddingHorizontal:6,paddingVertical: 4,borderWidth:0,borderRadius:10,zIndex: 100,backgroundColor: 'grey',borderColor:'grey'}}>
                     <Ionicons name="md-close" size={12} color="#fff" />
                      ...
                      <TouchableOpacity onPress={()=>this.props.navigation.navigate('CheckoutProducts')} style={{ width:width*0.2 }}>
           ...
           />
           <View style={{flex:0.3,flexWrap: 'nowrap',  flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-start', marginVertical: 10,paddingVertical:10,paddingHorizontal:3,backgroundColor:'#fff',marginBottom: 10,paddingBottom:10 , }}>
          ...
          <View style={{flex:0.1,position:'absolute',bottom:0,left:10,right:10,borderTopWidth:3,borderTopColor:'#e6e6e6',borderBottomWidth:3,borderBottomColor:'#e6e6e6',}}>
            <ScrollView style={{flex:0.5,backgroundColor:'#fff',height:height*0.15}}>
            ...
            <View style={{flex:0.5,backgroundColor:'#fff',marginBottom: 10,padding:10,borderTopWidth:3,borderTopColor:'#e6e6e6',height:height*0.17}}>
              ...
              <View style={{flex:1,flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'flex-start',marginTop:10}}>
