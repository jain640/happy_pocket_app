...
import  CNRichTextEditor , { CNToolbar , getDefaultStyles, convertToObject,convertToHtmlString ,getInitialObject} from "react-native-cn-richtext-editor";
...
class RichTextScreen1 extends Component {
    ...
    onValueChanged = (value) => {
        ...
        this.props.textChange(convertToHtmlString(value))
    }
            ...
            <MenuProvider style={{flex: 1}}>
                  ...
                  <View style={styles.toolbarContainer}>
                      ...
                      <CNToolbar
                          ...
                          backgroundColor="#fff" // optional (will override default backgroundColor)
                          color="gray" // optional (will override default color)
                          selectedColor='white' // optional (will override default selectedColor)
                          selectedBackgroundColor='#142e5c' // optional (will override default selectedBackgroundColor)
                          />
                  </View>
...
export default RichTextScreen1;
